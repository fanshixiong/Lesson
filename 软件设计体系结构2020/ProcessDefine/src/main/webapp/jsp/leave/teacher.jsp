        ...
        <table class="table table-hover table-responsive table-striped table-bordered">
            ...
            <c:forEach var="form" items="${forms}">
                ...
                <tr>
                    ...
                    <td>
                        <span>
						    <c:if test="${form.state == 1}">辅导员老师已审核，待您确认</c:if>
						    <c:if test="${form.state == 2}">您已审核</c:if>
					    </span>
                    </td>
                    <td>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/leaveform2.js"></script>