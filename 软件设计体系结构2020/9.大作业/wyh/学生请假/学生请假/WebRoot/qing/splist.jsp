						...
						<br>
							...
							<table width="95%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="15%" height="30" class="TitleHighlight">
										<div align="center" style="font-weight: bold; color: #ffffff">
											审批状态
										</div>
									</td>
								...
								<%
									...
									String sql = "select * from qing where banji in ("+session.getAttribute("banji")+")";
									if (queryName != null) {
								...
								<tr>
									...
									<td height="40" class='forumRow'>
										<div align="center">
											<%
											  ...
											  if(state.equals("提交申请")){
											   
											%>
											 <%=state %>（ <a href="<%=path%>/SpQingAction?id=<%=id%>&sp=ty">同意</a>
											  <a href="<%=path%>/SpQingAction?id=<%=id%>&sp=bty">不同意</a>）
											<%}else{ %>
											  <%=state %>
											<%} %>
										</div>
									...
									<td class='forumRow'>
										<div align="center">
											...
											<a href="<%=path%>/DelQingAction?id=<%=id%>">删除</a>
										</div>
									</td>
								</tr>
							...
							<table width="95%" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td height="70">
										<form action="<%=path%>/qing/list.jsp" method="post">
											<div align="center">
												&nbsp;
												<label>
												</label>
