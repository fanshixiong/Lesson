...
<div class="right">
    ...
    <div class="container">
        <a href="${pageContext.request.contextPath }/jsp/leave/leaveadd.jsp">添加申请单</a>
        ...
        <table class="table table-hover table-responsive table-striped table-bordered">
            ...
            <c:forEach var="form" items="${forms}">
                ...
                <tr>
                    ...
                    <td>
                        <span>
						    <c:if test="${form.state == 0}">等待辅导员审核</c:if>
						    <c:if test="${form.state == 1}">辅导员已审核，等待院长通过</c:if>
                            <c:if test="${form.state == 2}">院长通过</c:if>
